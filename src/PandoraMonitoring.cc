...
void PandoraMonitoring::InitializeGaps(TGeoVolume *pMainDetectorVolume, TGeoMedium *pGapMedium, Char_t transparency)
{
	...
	pGapVol->SetLineColor((TPC_VIEW_U == hitType) ? kRed: (TPC_VIEW_V == hitType) ? kGreen: kBlue);
	pGapVol->SetFillColor((TPC_VIEW_U == hitType) ? kRed: (TPC_VIEW_V == hitType) ? kGreen: kBlue);
